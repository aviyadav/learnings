 ...
 */
package org.sample.avro.util.model;
...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public org.sample.avro.util.model.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<java.lang.CharSequence> employeeNames;
  @Deprecated public org.sample.avro.util.model.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, org.sample.avro.util.model.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, org.sample.avro.util.model.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (org.sample.avro.util.model.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (org.sample.avro.util.model.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public org.sample.avro.util.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(org.sample.avro.util.model.ClientIdentifier value) {
   ...
   */
  public org.sample.avro.util.model.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(org.sample.avro.util.model.Active value) {
    this.active = value;
  }
   ...
   */
  public static org.sample.avro.util.model.AvroHttpRequest.Builder newBuilder() {
    return new org.sample.avro.util.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static org.sample.avro.util.model.AvroHttpRequest.Builder newBuilder(org.sample.avro.util.model.AvroHttpRequest.Builder other) {
    return new org.sample.avro.util.model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static org.sample.avro.util.model.AvroHttpRequest.Builder newBuilder(org.sample.avro.util.model.AvroHttpRequest other) {
    return new org.sample.avro.util.model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private org.sample.avro.util.model.ClientIdentifier clientIdentifier;
    private org.sample.avro.util.model.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private org.sample.avro.util.model.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.sample.avro.util.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = org.sample.avro.util.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.sample.avro.util.model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder setClientIdentifier(org.sample.avro.util.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public org.sample.avro.util.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(org.sample.avro.util.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(org.sample.avro.util.model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public org.sample.avro.util.model.AvroHttpRequest.Builder setClientIdentifierBuilder(org.sample.avro.util.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder setActive(org.sample.avro.util.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.sample.avro.util.model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (org.sample.avro.util.model.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (org.sample.avro.util.model.Active) defaultValue(fields()[3]);
        return record;
