package com.sample.lmax.disruptor.perf.support;

import java.util.ArrayList;
import java.util.concurrent.BlockingQueue;
import java.util.concurrent.CountDownLatch;

public class ValueAdditionBatchQueueProcessor implements Runnable {
    ...
    public ValueAdditionBatchQueueProcessor(final BlockingQueue<Long> blockingQueue, long count) {
