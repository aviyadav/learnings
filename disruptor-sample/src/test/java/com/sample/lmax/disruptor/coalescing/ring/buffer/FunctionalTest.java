...
import static com.sample.lmax.disruptor.coalescing.ring.buffer.MarketSnapshot.createMarketSnapshot;
...
public class FunctionalTest {
    ...
    private static final MarketSnapshot VOD_SNAPSHOT_1 = createMarketSnapshot(1, 3, 4);
    private static final MarketSnapshot VOD_SNAPSHOT_2 = createMarketSnapshot(1, 5, 6);
    private static final MarketSnapshot BP_SNAPSHOT = createMarketSnapshot(2, 7, 8);
    ...
    private CoalescingBuffer<Long, MarketSnapshot> createBuffer(int capacity) {
