...
public class emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2536115857478252786L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"emp\",\"namespace\":\"avro.samples\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"salary\",\"type\":\"int\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"address\",\"type\":\"string\"}]}");
   ...
   */
  public static avro.samples.emp.Builder newBuilder() {
    return new avro.samples.emp.Builder();
  }
   ...
   * @return A new emp RecordBuilder
   */
  public static avro.samples.emp.Builder newBuilder(avro.samples.emp.Builder other) {
    return new avro.samples.emp.Builder(other);
  }
   ...
   * @return A new emp RecordBuilder
   */
  public static avro.samples.emp.Builder newBuilder(avro.samples.emp other) {
    return new avro.samples.emp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<emp>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.samples.emp.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.samples.emp other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder setSalary(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder clearSalary() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.samples.emp.Builder clearAddress() {
      address = null;
